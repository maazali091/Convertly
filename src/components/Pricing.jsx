            ...
            <div className="mx-auto max-w-6xl">
                ...
                <div className="grid gap-7 lg:grid-cols-2">
                    <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                        ...
                        <button type="button" className="mt-8 w-full rounded-xl bg-slate-100 px-5 py-3.5 text-base font-semibold text-slate-900 transition hover:bg-slate-200 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700">
                            Get Started
                        </button>
                        <div className="mt-9 space-y-5">
                            <Feature text="50MB per file" color="green" />
                            <Feature text="5 conversions/day" color="green"/>
                            <Feature text="Basic Support" color="green" />
                        </div>
                    </div>
                    <div className="relative rounded-2xl border-2 border-blue-500 bg-linear-to-br from-blue-50 via-white to-purple-50 p-8 shadow-xl shadow-blue-100 dark:from-blue-500/10 dark:via-slate-900 dark:to-purple-500/10 dark:shadow-none">
                        ...
                        <div className="mt-9 space-y-5">
                            ...
                            <Feature text="Priority support" color="blue"/>
                            <Feature text="Batch processing" color="blue"/>
                            <Feature text="API access" color="blue" />
                            <Feature text="Advanced analytics"color="blue"/>
                        </div>
                    </div>
